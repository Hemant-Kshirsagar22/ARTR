...
VkResult initialize(void)
{
    ...
    VkResult createTexture(const char *, MyTexture *);
    ...
    // create texture
    vkResult = createTexture("stone.png", &stone);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> createTexture() failed for stone.png !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> createTexture() success for stone.png \n\n", __func__);
    }

    vkResult = createTexture("kundali.png", &kundali);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> createTexture() failed for kundali.png !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> createTexture() success for kundali.png \n\n", __func__);
    }
...
void uninitialize(void)
{
    ...
    if(uniformData_pyramid.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_pyramid.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(uniformData_pyramid.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_pyramid.vkBuffer is freed\n", __func__);
    }

    // free uniformData for cube
    if(uniformData_cube.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_cube.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(uniformData_cube.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_cube.vkBuffer is freed\n", __func__);
    }

    // for texture
    // for kundali
    if (kundali.vkSampler)
    {
        vkDestroySampler(vkDevice, kundali.vkSampler, NULL);
        kundali.vkSampler = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> kundali.vkSampler is freed\n", __func__);
    }

    if (kundali.vkImageView)
    {
        vkDestroyImageView(vkDevice, kundali.vkImageView, NULL);
        kundali.vkImageView = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> kundali.vkImageView is freed\n", __func__);
    }

    if (kundali.vkDeviceMemory)
    {
        vkFreeMemory(vkDevice, kundali.vkDeviceMemory, NULL);
        kundali.vkDeviceMemory = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> kundali.vkDeviceMemory is freed\n", __func__);
    }

    if (kundali.vkImage)
    {
        vkDestroyImage(vkDevice, kundali.vkImage, NULL);
        kundali.vkImage = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> kundali.vkImage is free\n", __func__);
    }

    // for stone
    if (stone.vkSampler)
    {
        vkDestroySampler(vkDevice, stone.vkSampler, NULL);
        stone.vkSampler = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> stone.vkSampler is freed\n", __func__);
    }

    if (stone.vkImageView)
    {
        vkDestroyImageView(vkDevice, stone.vkImageView, NULL);
        stone.vkImageView = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> stone.vkImageView is freed\n", __func__);
    }

    if (stone.vkDeviceMemory)
    {
        vkFreeMemory(vkDevice, stone.vkDeviceMemory, NULL);
        stone.vkDeviceMemory = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> stone.vkDeviceMemory is freed\n", __func__);
    }

    if (stone.vkImage)
    {
        vkDestroyImage(vkDevice, stone.vkImage, NULL);
        stone.vkImage = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> stone.vkImage is free\n", __func__);
    }
    ...
    if(vertexData_texcoord_cube.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_texcoord_cube.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_texcoord_cube.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_texcoord_cube.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_position_cube.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_cube.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_position_cube.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_cube.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_texcoord_pyramid.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_texcoord_pyramid.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_texcoord_pyramid.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_texcoord_pyramid.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_position_pyramid.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_pyramid.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_position_pyramid.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_pyramid.vkBuffer is freed\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
   ...
   // ------------------------------------ pyramid ----------------------------------------
    ...
    // memset our global vertexData_position_pyramid struct.
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_position_pyramid.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_position_pyramid.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_position_pyramid.vkDeviceMemory\n\n", __func__);
    }
    ...
    void *data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_pyramid.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_texcoord_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_texcoord_pyramid \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_texcoord_pyramid.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_texcoord_pyramid.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_texcoord_pyramid.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord_pyramid.vkBuffer, vertexData_texcoord_pyramid.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_texcoord_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_texcoord_pyramid\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord_pyramid.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_texcoord_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_texcoord_pyramid\n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_position_cube.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_position_cube.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_position_cube.vkDeviceMemory\n\n", __func__);
    }
    ...
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_cube.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed !!!\n\n", __func__);
        return (vkResult);
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_texcoord_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_texcoord_cube \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_texcoord_cube.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_texcoord_cube.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_texcoord_cube.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_texcoord_cube.vkBuffer, vertexData_texcoord_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_texcoord_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_texcoord_cube\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_texcoord_cube.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_texcoord_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_texcoord_cube\n\n", __func__);
    }
...
VkResult createTexture(const char *textureFileName, MyTexture *texture)
{
    // local variable declaration
    VkResult vkResult = VK_SUCCESS;
    FILE *fp = NULL;
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateImage() failed for vkImage_texture (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateImage() call success for vkImage_texture \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo_image, NULL, &texture->vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vkDeviceMemory_texture failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vkDeviceMemory_texture\n\n", __func__);
    }
    ...
    vkCmdCopyBufferToImage(vkCommandBuffer_buffer_to_image_copy, vkBuffer_stagingBuffer, texture->vkImage, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &vkBufferImageCopy);
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateImageViews() failed for vkImageView_texture !!! (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateImageViews() call success for vkImageView_texture \n\n", __func__);
    }
...
VkResult createUniformBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success pyramid\n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &uniformData_pyramid.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for uniformData_pyramid.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for uniformData_pyramid.vkDeviceMemory\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success cube\n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &uniformData_cube.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for uniformData_cube.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for uniformData_cube.vkDeviceMemory\n\n", __func__);
    }
...
VkResult updateUniformBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for uniformData_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed  for uniformData_cube !!!\n\n", __func__);
        return (vkResult);
    }
...
VkResult createDescriptorSet(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() failed (ERROR CODE : %d )!!! for pyramid \n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() call success for pyramid \n\n", __func__);
    }
    ...
    vkDescriptorImageInfo.imageView = stone.vkImageView;
    vkDescriptorImageInfo.sampler = stone.vkSampler;
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() failed for vkDescriptorSet_cube (ERROR CODE : %d )!!! for cube \n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() call success for cube \n\n", __func__);
    }
    ...
    vkDescriptorImageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
    vkDescriptorImageInfo.imageView = kundali.vkImageView;
    vkDescriptorImageInfo.sampler = kundali.vkSampler;
...
VkResult buildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 1, 1, &vertexData_texcoord_pyramid.vkBuffer, vkDeviceSize_offset_texcoord);
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 0, 1, &vertexData_position_cube.vkBuffer, vkDeviceSize_offset_position);

        // for texcoord
        memset((void *)vkDeviceSize_offset_texcoord, 0, sizeof(VkDeviceSize) * _ARRAYSIZE(vkDeviceSize_offset_texcoord));

        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 1, 1, &vertexData_texcoord_cube.vkBuffer, vkDeviceSize_offset_texcoord);
...
/**
-----------------------------------------------------------------------------------------------
STEPS FOR CREATE TEXTURE
------------------------
1. declare iamge global data. 
2. Get Image info like width, hight number of channels and actual data using functions in stb_image.h
3. Put above image data into a staging buffer
4. Create "device only visible", empty but enough size image  equal to size of (width x height). 
5. Send "image transition layout" to the vulkan / GPU before the actual staging buffer (from step 3) to the empty image (in step 4) copy using pipeline barrier. 
6. Now actally copy the image data from staging buffer to the empty vkImage. 
7. Now again do image layout transition similar to the step 5 for correct reading / writing of the data by the shaders. 
8. Now staging buffer is not needed, hence release its data and memory.
9. create image view for above image.
10. create texture sampler for above image.
11. uninitialize texture related all global data like vkImage, vkDeviceImage of image vkImageView of image and image sampler. 
-----------------------------------------------------------------------------------------------
