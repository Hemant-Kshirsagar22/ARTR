...
{
    // code
    angle_tepot = angle_tepot + 1.0f;
    if(angle_tepot >= 360.0f)
    {
        angle_tepot = angle_tepot - 360.0f;
    }
}
...
VkResult updateUniformBuffer(void)
{
    ...
    rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(angle_tepot), glm::vec3(0.0f, 1.0f, 0.0f));
