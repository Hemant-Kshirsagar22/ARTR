...
void uninitialize(void)
{
    ...
    if(vkDescriptorPool)
    {
        ...
        fprintf(gpFile, "%s()-> vkDescriptorPool and vkDescriptorSet_pyramid and vkDescriptorSet_cube destroyed Successfully\n", __func__);
    }
    ...
    if(vertexData_color_cube.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_cube.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_color_cube.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_cube.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_color_pyramid.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_pyramid.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_color_pyramid.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_pyramid.vkBuffer is freed\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_color_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_color_pyramid \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_color_pyramid.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_color_pyramid.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_color_pyramid.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_pyramid.vkBuffer, vertexData_color_pyramid.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_color_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_color_pyramid\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_pyramid.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_color_pyramid !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_color_pyramid \n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_color_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_color_cube \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_color_cube.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_color_cube.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_color_cube.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_cube.vkBuffer, vertexData_color_cube.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_color_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_color_cube\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_cube.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_color_cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_color_cube \n\n", __func__);
    }
...
VkResult createUniformBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed cube !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
...
VkResult createDescriptorSet(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() failed (ERROR CODE : %d ) for cube !!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
...
VkResult createPipeline(void)
{
    ...
    // for position
    vkVertexInputBindingDescription_array[0].binding = 0; // corrosponding to layout = 0 in vertex shader
    vkVertexInputBindingDescription_array[0].stride = sizeof(float) * 3;
    vkVertexInputBindingDescription_array[0].inputRate = VK_VERTEX_INPUT_RATE_VERTEX;

    // for color
    vkVertexInputBindingDescription_array[1].binding = 1; // corrosponding to layout = 1 in vertex shader
...
VkResult buildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 1, 1, &vertexData_color_pyramid.vkBuffer, vkDeviceSize_offset_color);
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 1, 1, &vertexData_color_cube.vkBuffer, vkDeviceSize_offset_color);
