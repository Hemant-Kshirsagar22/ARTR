...
2. in initialize declare and call UDF createDescriptorLayout() maintaining the convension of declaring and calling of after createShaders() and before createRenderPass().
...
5. In uninitialize() call vkDesotryDescriptorSetLayout() to destory vkDescriptorSetLayout. 
