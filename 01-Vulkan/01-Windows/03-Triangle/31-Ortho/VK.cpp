...
VkResult updateUniformBuffer(void)
{
    ...
    glm::mat4 orthographicPojectionMatrix = glm::mat4(1.0);
    
    if(winWidth <= winHeight)
    {
        orthographicPojectionMatrix = glm::ortho(-100.0f,
        100.0f,
    ...
    {
        orthographicPojectionMatrix = glm::ortho(-100.0f  * ((float)winWidth / (float)winHeight),
    ...
    myUniformData.projectionMatrix = orthographicPojectionMatrix;
...
resize means recreation of swapchain
