...
// for per vertex light shaders
VkShaderModule vkShaderModule_vertex_shader_per_vertex = VK_NULL_HANDLE;
VkShaderModule vkShaderModule_fragment_shader_per_vertex = VK_NULL_HANDLE;

// for per vertex light shaders
VkShaderModule vkShaderModule_vertex_shader_per_fragment = VK_NULL_HANDLE;
VkShaderModule vkShaderModule_fragment_shader_per_fragment = VK_NULL_HANDLE;
...
void uninitialize(void)
{
    ...
    if (vkShaderModule_fragment_shader_per_fragment)
    {
        vkDestroyShaderModule(vkDevice, vkShaderModule_fragment_shader_per_fragment, NULL);
        vkShaderModule_fragment_shader_per_fragment = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> vkShaderModule_fragment_shader_per_fragment is freed\n", __func__);
    }

    // free vertex shader
    if (vkShaderModule_vertex_shader_per_fragment)
    {
        vkDestroyShaderModule(vkDevice, vkShaderModule_vertex_shader_per_fragment, NULL);
        vkShaderModule_vertex_shader_per_fragment = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> vkShaderModule_vertex_shader_per_fragment is freed\n", __func__);
    }

    // for per vertex light
    // free fragment shader
    if (vkShaderModule_fragment_shader_per_vertex)
    {
        vkDestroyShaderModule(vkDevice, vkShaderModule_fragment_shader_per_vertex, NULL);
        vkShaderModule_fragment_shader_per_vertex = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> vkShaderModule_fragment_shader_per_vertex is freed\n", __func__);
    }

    // free vertex shader
    if (vkShaderModule_vertex_shader_per_vertex)
    {
        vkDestroyShaderModule(vkDevice, vkShaderModule_vertex_shader_per_vertex, NULL);
        vkShaderModule_fragment_shader_per_vertex = VK_NULL_HANDLE;
        fprintf(gpFile, "%s()-> vkShaderModule_vertex_shader_per_vertex is freed\n", __func__);
    }
...
VkResult createShaders(void)
{
    ...
    // for vertex shader
    const char *szFileName = "./shaders/shader_per_vertex.vert.spv";
    FILE *fp = NULL;
    size_t size;
    ...
    vkResult = vkCreateShaderModule(vkDevice, &vkShaderModuleCreateInfo, NULL, &vkShaderModule_vertex_shader_per_vertex);
    ...
    szFileName = "./shaders/shader_per_vertex.frag.spv";
    fp = NULL;
    size = 0;
    ...
    // call vkCreateShaderModule() vulkan api, pass above struct pointer to it as parameter and obtain shader module object in global variable
    vkResult = vkCreateShaderModule(vkDevice, &vkShaderModuleCreateInfo, NULL, &vkShaderModule_fragment_shader_per_vertex);
    ...
    // for vertex shader
    szFileName = "./shaders/shader_per_frag.vert.spv";
    fp = NULL;
    size = 0;
    ...
    // call vkCreateShaderModule() vulkan api, pass above struct pointer to it as parameter and obtain shader module object in global variable
    vkResult = vkCreateShaderModule(vkDevice, &vkShaderModuleCreateInfo, NULL, &vkShaderModule_vertex_shader_per_fragment);
    ...
    fprintf(gpFile, "%s()-> vertex shader module successfully created for per fragment\n\n", __func__);
    //---------------------------------------------------------------------------------
    // for fragment shader

    szFileName = "./shaders/shader_per_frag.frag.spv";
    fp = NULL;
    size = 0;
    ...
    // call vkCreateShaderModule() vulkan api, pass above struct pointer to it as parameter and obtain shader module object in global variable
    vkResult = vkCreateShaderModule(vkDevice, &vkShaderModuleCreateInfo, NULL, &vkShaderModule_fragment_shader_per_fragment);
...
VkResult myUpdateShaders(void)
{
    ...
    {
        fprintf(gpFile, "%s()-> createPipeline() call success \n\n", __func__);
    }
    ...
    {
        fprintf(gpFile, "%s()-> buildCommandBuffers() call success \n\n", __func__);
    }
}
...
VkResult createPipeline(void)
{
    ...
    if(userLightChoice == 'V')
        vkPipelineShaderStageCreateInfo_array[0].module = vkShaderModule_vertex_shader_per_vertex;
    else
        vkPipelineShaderStageCreateInfo_array[0].module = vkShaderModule_vertex_shader_per_fragment;
    ...
    if(userLightChoice == 'V')
        vkPipelineShaderStageCreateInfo_array[1].module = vkShaderModule_fragment_shader_per_vertex;
    else
        vkPipelineShaderStageCreateInfo_array[1].module = vkShaderModule_fragment_shader_per_fragment;
...
-----------------------------------------------------------------------------------------------
 ...
 // for per vertex lighting
 C:\VulkanSDK\Vulkan\Bin\glslangValidator.exe -V -H -o .\shaders\shader_per_vertex.vert.spv .\shaders\shader_per_vertex.vert

 C:\VulkanSDK\Vulkan\Bin\glslangValidator.exe -V -H -o .\shaders\shader_per_vertex.frag.spv .\shaders\shader_per_vertex.frag

  // for per fragment lighting
 C:\VulkanSDK\Vulkan\Bin\glslangValidator.exe -V -H -o .\shaders\shader_per_frag.vert.spv .\shaders\shader_per_frag.vert

 C:\VulkanSDK\Vulkan\Bin\glslangValidator.exe -V -H -o .\shaders\shader_per_frag.frag.spv .\shaders\shader_per_frag.frag
