...
VkPhysicalDeviceFeatures vkPhysicalDeviceFeatures; // for geometry shader
...
void uninitialize(void)
{
    ...
    if (vkShaderModule_geometry_shader)
    {
        ...
        fprintf(gpFile, "%s()-> vkShaderModule_geometry_shader is freed\n", __func__);
    }
...
VkResult createVulkanDevice(void)
{
    ...
    else
    {
        ...
        fprintf(gpFile, "%s()-> GEOMETRY SHADER NOT SUPPORTED !!!\n\n\n\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
...
VkResult createShaders(void)
{
    ...
    szFileName = "./shaders/Shader.geom.spv";
    fp = NULL;
    size = 0;
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateShaderModule() failed for geometry shader !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateShaderModule() call success for geometry shader\n\n", __func__);
    }
