...
-----------------------------------------------------------------------------------------------
 ...
 STEPS FOR FENCES AND SEMAPHORE
 -------------------------------
 ...
 2. In createSemaphore() UDF(User Definend Function) declare , memset and initialize VkSemaphoreCreateInfo structure.
 ...
 4. In createFences() UDF declare, memset and initialze VkFenceCreateInfo structure.
