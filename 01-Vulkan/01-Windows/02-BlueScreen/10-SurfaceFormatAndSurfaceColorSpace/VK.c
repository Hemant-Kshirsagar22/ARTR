...
VkResult getPhysicalDeviceSurfaceFormatAndColorSpace(void)
{
    ...
    if(vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkGetPhysicalDeviceSurfaceFormatsKHR() failed !!!\n\n", __func__);
        return(vkResult);
    }
...
/**
 ...
 2. Declare and allocate array of VkSurfaceFormatStructure currosponding to above count, this structure has two members first VkFormat and  second VkColorSpaceKHR.
