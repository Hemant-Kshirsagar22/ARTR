...
VkResult createImagesAndImageView(void)
{
    ...
    vkResult = vkGetSwapchainImagesKHR(vkDevice, vkSwapchinKHR, &swapchainImageCount, NULL);
    if (vkResult != VK_SUCCESS)
    {
    ...
    vkResult = vkGetSwapchainImagesKHR(vkDevice, vkSwapchinKHR, &swapchainImageCount, swapchainImage_array);
    if (vkResult != VK_SUCCESS)
    {
...
/**
 ...
 -----------------------------------------------------------------------------------------------
 STEPS FOR SWAPCHAIN IMAGES AND IMAGE VIEW
 ----------------------------------------
 ...
 10. In uninitialize(), now actaully free the image view array using free().
