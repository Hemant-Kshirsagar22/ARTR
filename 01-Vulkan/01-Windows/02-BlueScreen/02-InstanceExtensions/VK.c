...
VkResult initialize(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile,"initialize()-> fillInstanceExtensionNames() failed !!!\n\n");
        return(vkResult);
    }
    else
    {
        fprintf(gpFile,"initialize()-> fillInstanceExtensionNames() success\n\n");
    }
...
VkResult fillInstanceExtensionNames(void)
{
	...
	fprintf(gpFile,"\n======================== STEP 1 STEPS FOR INSTANCE EXTENSIONS START ================================\n\n");
