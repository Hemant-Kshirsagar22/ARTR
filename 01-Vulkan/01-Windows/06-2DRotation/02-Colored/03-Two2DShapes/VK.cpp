...
void uninitialize(void)
{
    ...
    if(vkDescriptorPool)
    {
        ...
        fprintf(gpFile, "%s()-> vkDescriptorPool and vkDescriptorSet_triangle and vkDescriptorSet_rectangle destroyed Successfully\n", __func__);
    }
    ...
    if(uniformData_triangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_triangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(uniformData_triangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_triangle.vkBuffer is freed\n", __func__);
    }
    ...
    if(uniformData_rectangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_rectangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(uniformData_rectangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> uniformData_rectangle.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_position_rectangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_rectangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_position_rectangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_rectangle.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_color_rectangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_rectangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_color_rectangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_rectangle.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_position_triangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_triangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_position_triangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_position_triangle.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_color_triangle.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_triangle.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_color_triangle.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s()-> vertexData_color_triangle.vkBuffer is freed\n", __func__);
    }
...
VkResult createVertexBuffer(void)
{
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_position_triangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_position_triangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_position_triangle.vkDeviceMemory\n\n", __func__);
    }
    ...
    void *data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_triangle.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
    ...
    // ------------------ vertex color buffer for triangle
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_color_triangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_color_triangle \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_color_triangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_color_triangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_color_triangle.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_triangle.vkBuffer, vertexData_color_triangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_color_triangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_color_triangle\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_triangle.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_color_triangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_color_triangle \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_position_rectangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_position_rectangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_position_rectangle.vkDeviceMemory\n\n", __func__);
    }
    ...
    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_position_rectangle.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed !!!\n\n", __func__);
        return (vkResult);
    ...
    // ---------- vertex buffer for rectangle color
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() failed for vertexData_color_rectangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkCreateBuffer() call success for vertexData_color_rectangle \n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &vertexData_color_rectangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for vertexData_color_rectangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for vertexData_color_rectangle.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_color_rectangle.vkBuffer, vertexData_color_rectangle.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() failed for vertexData_color_rectangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkBindBufferMemory() call success for vertexData_color_rectangle\n\n", __func__);
    }

    data = NULL;
    vkResult = vkMapMemory(vkDevice, vertexData_color_rectangle.vkDeviceMemory, 0, vkMemeoryAllocateInfo.allocationSize, 0, &data);
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for vertexData_color_rectangle !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkMapMemory() call success for vertexData_color_rectangle \n\n", __func__);
    }
...
VkResult createUniformBuffer(void)
{
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &uniformData_triangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for uniformData_triangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for uniformData_triangle.vkDeviceMemory\n\n", __func__);
    }
    ...
    vkResult = vkAllocateMemory(vkDevice, &vkMemeoryAllocateInfo, NULL, &uniformData_rectangle.vkDeviceMemory);

    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() for uniformData_rectangle.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateMemory() call success for uniformData_rectangle.vkDeviceMemory\n\n", __func__);
    }
...
VkResult updateUniformBuffer(void)
{
    ...
    rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(angle_rectangle), glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed for uniformData_triangle !!!\n\n", __func__);
        return (vkResult);
    }
    ...
    translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(1.5f, 0.0f, -6.0f));
    rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(angle_rectangle), glm::vec3(1.0f, 0.0f, 0.0f));
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkMapMemory() failed  for uniformData_rectangle !!!\n\n", __func__);
        return (vkResult);
    }
...
VkResult createDescriptorSet(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() failed (ERROR CODE : %d )!!! for triangle \n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() call success for triangle \n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() failed (ERROR CODE : %d ) for rectangle !!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        fprintf(gpFile, "%s()-> vkAllocateDescriptorSets() call success for rectangle\n\n", __func__);
    }
