...
// VK_KHR_SURFACE_EXTENSION_NAME, VK_KHR_ANDROID_SURFACE_EXTENSION_NAME and VK_EXT_DEBUG_REPORT_EXTENSION_NAME we are using these two macros and going to store in following array
...
void android_main(struct android_app *state)
{
    ...
    while(1)
    {
        ...
        if(engine.bActive == true && bInitialized == true)
        {
            ...
            {
                __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s() -> Display Failed !!!", __func__);
                return;
            }
            update();
        }
    ...
    case APP_CMD_INIT_WINDOW:
        if(engine->app->window != NULL)
        {
            ...
            if(bInitialized == false)
            {
                ...
                {
                   __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s() -> initialize() failed !!!", __func__); 
                }
                else 
                {
                    __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s() -> initialize() success", __func__); 
                }
            }
...
VkResult initialize(void)
{
    ...
    // code
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "================================== INITIALIZATION START ===================================\n\n");
    vkResult = createVulkanInstance();
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> createVulkanInstance() failed %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> createVulkanInstance() success\n\n");
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> getSupportedSurface() failed %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> getSupportedSurface() success\n\n");
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> getPhysicalDevice() failed : %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> getPhysicalDevice() success\n\n");
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> printVKInfo() failed : %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "initialize()-> printVKInfo() success\n\n");
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createVulkanDevice() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createVulkanDevice() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createSwapchain() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createSwapchain() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createImagesAndImageView() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createImagesAndImageView() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createCommandPool() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createCommandPool() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createCommandBuffer() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createCommandBuffer() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createVertexBuffer() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createVertexBuffer() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createUniformBuffer() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createUniformBuffer() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createShaders() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createShaders() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorSetLayout() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorSetLayout() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createPipelineLayout() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createPipelineLayout() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorPool() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorPool() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorSet() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createDescriptorSet() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createRenderPass() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createRenderPass() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createPipeline() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createPipeline() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createFrameBuffers() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createFrameBuffers() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createSemaphores() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createSemaphores() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createFences() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> createFences() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> buildCommandBuffers() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> buildCommandBuffers() success\n\n", __func__);
    }

    // initialization is completed
    bInitialized = true;
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "Initializeation successfully !!!\n\n");
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "================================== INITIALIZATION END ==================================\n\n");
    return (vkResult);
}
...
VkResult resize(int width, int height)
{
    ...
    if(bInitialized == false)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> Initialization yet not completed or failed !!!\n\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
    ...
    if (vkDevice)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkDeviceWaitIdle is done\n", __func__);
    }

    // check precence of swapchain
    if(vkSwapchainKHR == VK_NULL_HANDLE)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchain is already NULL can not procced\n", __func__);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
...
VkResult display(void)
{
    ...
    if(bInitialized == false)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> initialization Yet Not Completed !!!\n\n", __func__);
    ...
    if(vkResult != VK_SUCCESS)
    {
        ...
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAcquireNextImageKHR() failed (ERROR CODE : %d) !!!\n\n", __func__, vkResult);
            return(vkResult);
        }
    }
    ...
    if(vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkWaitForFences() failed (ERROR CODE : %d) !!!\n\n", __func__, vkResult);
        return(vkResult);
    }
    ...
    if(vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkResetFences() failed (ERROR CODE : %d) !!!\n\n", __func__, vkResult);
        return(vkResult);
    }
    ...
    if(vkResult != VK_SUCCESS)
    {
        ...
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkQueuePresentKHR() failed (ERROR CODE : %d) !!!\n\n", __func__, vkResult);
            return(vkResult);
        }
    }
...
void uninitialize(void)
{
    ...
    if(vkFence_array)
    {
        free(vkFence_array);
        vkFence_array = NULL;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkFence_array freed\n", __func__);
    }
    ...
    if(vkSemaphore_renderComplete)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkSemaphore_renderComplete freed\n", __func__);
    }
    ...
    if(vkSemaphore_backBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkSemaphore_backBuffer freed\n", __func__);
    }
    ...
    if(vkPipeline)
    {
        vkDestroyPipeline(vkDevice, vkPipeline, NULL);
        vkPipeline = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkPipeline is freed\n", __func__);
    }
    ...
    if(vkRenderPass)
    {
        vkDestroyRenderPass(vkDevice, vkRenderPass, NULL);
        vkRenderPass = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkRenderPass is done\n", __func__);
    }
    ...
    if(vkDescriptorPool)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkDescriptorPool and vkDescriptorSet destroyed Successfully\n", __func__);
    }
    ...
    if (vkDescriptorSetLayout)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkDescriptorSetLayout is freed\n", __func__);
    }
    ...
    if (vkPipelineLayout)
    {
        vkDestroyPipelineLayout(vkDevice, vkPipelineLayout, NULL);
        vkPipelineLayout = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkPipelineLayout is freed\n", __func__);
    }
    ...
    if (vkShaderModule_fragment_shader)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkShaderModule_fragment_shader is freed\n", __func__);
    }
    ...
    if (vkShaderModule_vertex_shader)
    {
        ...
        vkShaderModule_fragment_shader = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkShaderModule_vertex_shader is freed\n", __func__);
    }
    ...
    if(uniformData.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> uniformData.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(uniformData.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> uniformData.vkBuffer is freed\n", __func__);
    }
    ...
    if(vertexData_position.vkDeviceMemory)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vertexData_position.vkDeviceMemory is freed\n", __func__);
    }
    ...
    if(vertexData_position.vkBuffer)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vertexData_position.vkBuffer is freed\n", __func__);
    }
    ...
    if (vkCommandBuffer_array)
    {
        free(vkCommandBuffer_array);
        vkCommandBuffer_array = NULL;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCommandBuffer_array is done\n", __func__);
    }
    ...
    if (vkCommandPool)
    {
        ...
        vkCommandPool = NULL;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCommandPool is done\n", __func__);
    }
    ...
    if (swapchainImageView_array)
    {
        free(swapchainImageView_array);
        swapchainImageView_array = NULL;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchainImageView_array is done\n", __func__);
    }
    ...
    if (vkSwapchainKHR)
    {
        vkDestroySwapchainKHR(vkDevice, vkSwapchainKHR, NULL);
        vkSwapchainKHR = VK_NULL_HANDLE;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkSwapchinKHR is uninitialized\n", __func__);
    }
    ...
    if (vkDevice)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkDevice is uninitialized\n", __func__);
    }
    ...
    if (vkSurfaceKHR)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "uninitialize()-> vkDestroySurfaceKHR() succeeded\n");
    }
    ...
    if (vkInstance)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "uninitialize()-> vkDestroyInstance() succeeded\n");
    }

    // close the log file
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "uninitialize()-> Program Ended Successfully !!!\n\n");
}
// ----------------------------------------------------------------------------------------------
...
VkResult createVulkanInstance(void)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "\n======================== STEPS FOR INSTANCE CREATION START ================================\n\n");
    vkResult = fillInstanceExtensionNames();
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> fillInstanceExtensionNames() failed !!!\n\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> fillInstanceExtensionNames() success\n\n");
    }
    ...
    {    
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> fillValidationLayerNames() failed !!!\n\n");
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> fillValidationLayerNames() success\n\n");
        }
    }
    ...
    if(bValidation == true)
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> createValidationCallbackFunction() failed !!!\n\n");
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "createVulkanInstance()-> createValidationCallbackFunction() success\n\n");
        }
    }
...
VkResult fillInstanceExtensionNames(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> 1st called to vkEnumerateInstanceExtensionProperties() failed !!!\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> 1st called to vkEnumerateInstanceExtensionProperties() success\n");
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> malloc() failed for vkExtensionProperties_array\n");
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> 2nd called to vkEnumerateInstanceExtensionProperties() failed !!!\n\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> 2nd called to vkEnumerateInstanceExtensionProperties() success\n\n");
    }
    ...
    if (vkExtensionProperties_array == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> malloc() failed for instanceExtensionName_array\n");
        return (VK_ERROR_OUT_OF_DEVICE_MEMORY);
    }
    ...
    for (uint32_t i = 0; i < instanceExtensionCount; i++)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> vlkan extension name : %s\n", instanceExtensionNames_array[i]);
    }
    ...
    // 5. find whether above extension names contain our required two extentions (VK_KHR_SURFACE_EXTENSION_NAME macro of VK_KHR_surface, VK_KHR_ANDROID_SURFACE_EXTENSION_NAME macro of VK_KHR_win32_surface) accordingly set two global variable.
    ...
    {
        vkResult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> VK_KHR_ANDROID_SURFACE_EXTENSION_NAME NOT FOUND !!!\n\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> VK_KHR_ANDROID_SURFACE_EXTENSION_NAME FOUND !!!\n\n");
    }
    ...
    if(debugReportExtensionFound == VK_FALSE)
    {
        ...
        {
            vkResult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> Validation is on but VK_EXT_DEBUG_REPORT_EXTENSION_NAME NOT SUPPORTED !!!\n\n");
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> Validation is off and VK_EXT_DEBUG_REPORT_EXTENSION_NAME NOT SUPPORTED !!!\n\n");
        }
    }
    else
    {
        if(bValidation == true)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> Validation is on and VK_EXT_DEBUG_REPORT_EXTENSION_NAME SUPPORTED\n\n");
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> Validation is off but VK_EXT_DEBUG_REPORT_EXTENSION_NAME SUPPORTED\n\n");
        }
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillInstanceExtensionNames()-> ENABLED VULKAN INSTANCE EXTENTION NAME : %s\n", enabledInstanceExtensionNames_array[i]);
    }
...
VkResult fillValidationLayerNames(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> 1st called to vkEnumerateInstanceLayerProperties() failed !!!\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> 1st called to vkEnumerateInstanceLayerProperties() success\n");
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() failed for vkLayerProperties_array !!!\n\n", __func__);        
		return(VK_ERROR_OUT_OF_DEVICE_MEMORY);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() success for vkLayerProperties_array\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> 2nd called to vkEnumerateInstanceLayerProperties() failed !!!\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> 2nd called to vkEnumerateInstanceLayerProperties() success\n");
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() failed for validationLayerNames_array !!!\n\n", __func__);        
		return(VK_ERROR_OUT_OF_DEVICE_MEMORY);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() success for validationLayerNames_array\n\n", __func__);
    }
    ...
    for(uint32_t i = 0; i < validationLayerCount; i++)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> vlkan validation layer name : i = %d => %s\n", i, validationLayerNames_array[i]);
    }
    ...
    if(bValidation == true)
    {
        ...
        {
            vkResult = VK_ERROR_INITIALIZATION_FAILED; // return hardcoded failure
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> VK_LAYER_KHRONOS_validation NOT SUPPORTED !!!\n\n");
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> VK_LAYER_KHRONOS_validation SUPPORTED !!!\n\n");
        }
    }

    for(uint32_t i = 0; i < enabledValidationLayerCount; i++)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "fillValidationLayerNames()-> ENABLED VULKAN VALIDATION LAYER NAME : %s\n\n", enabledValidationLayerNames_array[i]);
    }
...
VkResult createValidationCallbackFunction(void)
{
    ...
    {
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetInstanceProcAddr() failed to get function pointer for vkCreateDebugReportCallbackEXT\n\n", __func__);
        return(vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetInstanceProcAddr() function pointer for vkCreateDebugReportCallbackEXT found\n\n", __func__);
    }
    ...
    {
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetInstanceProcAddr() failed to get function pointer for vkDestroyDebugReportCallbackEXT\n\n", __func__);
        return(vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetInstanceProcAddr() function pointer for vkDestroyDebugReportCallbackEXT found\n\n", __func__);
    }
    ...
    if(vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDebugReportCallbackEXT_fnptr() failed !!!\n\n", __func__);
        return(vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDebugReportCallbackEXT_fnptr() success\n\n", __func__);
    }
...
VkResult getSupportedSurface(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getSupportedSurface()-> vkCreateAndroidSurfaceKHR() FAILED !!!\n\n");
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getSupportedSurface()-> vkCreateWin32SufaceKHR() Success !!!\n\n");
    }
...
VkResult getPhysicalDevice(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> 1st call vkEnumeratePhysicalDevices() FAILED %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else if (physicalDeviceCount == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> vkEnumeratePhysicalDevices() : physicalDeviceCount = 0 !!!\n\n");
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> 1st call vkEnumeratePhysicalDevices() Success !!!\n\n");
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> 2nd call vkEnumeratePhysicalDevices() FAILED %d !!!\n\n", vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> 2nd call vkEnumeratePhysicalDevices() Success !!!\n\n");
    }
    ...
    if (bFound == VK_TRUE)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> get physical device selected with graphic enable\n\n");
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> get physical device selected with graphic enable failed !!!\n\n");

        if (vkPhysicalDevice_array)
        {
            free(vkPhysicalDevice_array);
            vkPhysicalDevice_array = NULL;
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkPhyscialDevice_array free\n", __func__);
        }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> tessellationShader Supported\n\n");
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> tessellationShader NOT Supported !!!\n\n");
    }

    // 11. By Using "geometryShaderMember" of above structure check selected device geometry shader support.
    if (vkPhysicalDeviceFeatures.geometryShader)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> geometryShader Supported\n\n");
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "getPhysicalDevice()-> geometryShader NOT Supported !!!\n\n");
    }
...
VkResult printVKInfo(void)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\t\t\tVULKAN INFORMATION\n\n");
    ...
    for (uint32_t i = 0; i < physicalDeviceCount; i++)
    {
        ...
        // api version
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN API VERSION : %d.%d.%d\n", majorVersion, minorVersion, patchVersion);

        // device name
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE NAME : %s\n", vkPhysicalDeviceProperties.deviceName);

        // device type
        switch (vkPhysicalDeviceProperties.deviceType)
        {
        case VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : INTEGRATED GPU (iGPU)\n");
            break;

        case VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : DISCRETE GPU (dGPU)\n");
            break;

        case VK_PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : VIRTUAL GPU (vGPU)\n");
            break;

        case VK_PHYSICAL_DEVICE_TYPE_CPU:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : CPU\n");
            break;

        case VK_PHYSICAL_DEVICE_TYPE_OTHER:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : OTHER\n");
            break;

        default:
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE TYPE : UNKNOWN\n");
            break;
        }

        // vendor id
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN VENDER ID   : 0x%04x\n", vkPhysicalDeviceProperties.vendorID);

        // device id
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "\t\t\tVULKAN DEVICE ID   : 0x%04x\n\n\n", vkPhysicalDeviceProperties.deviceID);
    }
...
VkResult fillDeviceExtensionNames(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> 1st called to vkEnumerateDeviceExtensionProperties() failed !!!\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> 1st called to vkEnumerateDeviceExtensionProperties() success\n", __func__);
    ...
    if (vkExtensionProperties_array == NULL)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() failed for vkExtensionProperties_array\n", __func__);
        return (VK_ERROR_OUT_OF_DEVICE_MEMORY);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> 2nd called to vkEnumerateDeviceExtensionProperties() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> 2nd called to vkEnumerateDeviceExtensionProperties() success\n\n", __func__);
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> malloc() failed for deviceExtensionNames_array\n", __func__);
    }
    ...
    for (uint32_t i = 0; i < deviceExtensionCount; i++)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vulkan device extension name : %s\n", __func__, deviceExtensionNames_array[i]);
    }
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> ENABLED VULKAN DEVICE EXTENTION NAME : %s\n", __func__, enabledDeviceExtensionNames_array[i]);
    }
...
VkResult createVulkanDevice(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> fillDeviceExtensionNames() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> fillDeviceExtensionNames() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDevice() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDevice() Created !!!\n\n", __func__);
    }
...
void getDeivceQueue(void)
{
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetDeviceQueue() failed !!!\n\n", __func__);
        return;
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetDeviceQueue() succeeded !!!\n\n", __func__);
    }
...
VkResult getPhysicalDeviceSurfaceFormatAndColorSpace(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceFormatsKHR() 1st call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else if (formatCount == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> format count is zero\n\n", __func__);
        return (VK_ERROR_INITIALIZATION_FAILED);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceFormatsKHR() 1st call success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceFormatsKHR() 2nd call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceFormatsKHR() 2nd call success\n\n", __func__);
    }
...
VkResult getPhysicalDevicePresentMode(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfacePresentModesKHR() 1st call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else if (presentModeCount == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> presentModeCount is zero\n\n", __func__);
        return (VK_ERROR_INITIALIZATION_FAILED);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfacePresentModesKHR() 1st call success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfacePresentModesKHR() 2nd call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfacePresentModesKHR() 2nd call success\n\n", __func__);
    }
...
VkResult createSwapchain(VkBool32 vsync)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> getPhysicalDeviceSurfaceFormatAndColorSpace() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> getPhysicalDeviceSurfaceFormatAndColorSpace() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceCapabilitiesKHR() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkGetPhysicalDeviceSurfaceCapabilitiesKHR() success\n\n", __func__);
    }
    ...
    if (vkSurfaceCapabilitiesKHR.currentExtent.width != UINT32_MAX)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchain image width x heght : %d x %d\n", __func__, vkExtent2D_swapchain.width, vkExtent2D_swapchain.height);
    }
    else
    {
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> getPhysicalDevicePresentMode() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> getPhysicalDevicePresentMode() success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSwapchainKHR() failed !!! (ERROR CODE : %d)\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSwapchainKHR() success\n\n", __func__);
    }
...
VkResult createImagesAndImageView(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageView() 1st call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else if (swapchainImageCount == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchainImageCount is zero 1st call\n\n", __func__);
        return (VK_ERROR_INITIALIZATION_FAILED);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageView() 1st call success\n\n", __func__);
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchainimage count : %d\n\n", __func__, swapchainImageCount);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageView() 2st call failed !!!\n\n", __func__);
        return (vkResult);
    }
    else if (swapchainImageCount == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchainImageCount is zero 2nd call\n\n", __func__);
        return (VK_ERROR_INITIALIZATION_FAILED);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageView() 2st call success\n\n", __func__);
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> swapchainimage count : %d\n\n", __func__, swapchainImageCount);
    }
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageViews() failed  for i = %d (ERROR CODE : %d )!!!\n\n", __func__, i, vkResult);
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateImageViews() call success for i = %d\n\n", __func__, i);
        }
    }
...
VkResult createCommandPool(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateCommandPool() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateCommandPool() call success\n\n", __func__);
    }
...
VkResult createCommandBuffer(void)
{
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if (vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateCommandBuffers() failed  for i = %d (ERROR CODE : %d )!!!\n\n", __func__, i, vkResult);
            return (vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateCommandBuffers() call success for i = %d\n\n", __func__, i);
        }
    }
...
VkResult createVertexBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateBuffer() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateBuffer() call success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateMemory() for vertexData_position.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateMemory() call success for vertexData_position.vkDeviceMemory\n\n", __func__);
    }

    vkResult = vkBindBufferMemory(vkDevice, vertexData_position.vkBuffer, vertexData_position.vkDeviceMemory, 0);
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkBindBufferMemory() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkBindBufferMemory() call success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkMapMemory() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkMapMemory() call success\n\n", __func__);
    }
...
VkResult createUniformBuffer(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateMemory() for uniformData.vkDeviceMemory failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateMemory() call success for uniformData.vkDeviceMemory\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> updateUniformBuffer() failed !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> updateUniformBuffer() call success\n\n", __func__);
    }
...
VkResult createShaders(void)
{
    ...
    if (size == 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> %s file size is 0 !!!\n\n", __func__, szFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
    ...
    if (retVal < 0)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> failed to read %s file !!!\n\n", __func__, szFileName);
        vkResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> success to read %s file !!!\n\n", __func__, szFileName);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateShaderModule() failed for vertex shader !!! \n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateShaderModule() call success for vertex shader\n\n", __func__);
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vertex shader module successfully created\n\n", __func__);
    //---------------------------------------------------------------------------------
    // for fragment shader
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateShaderModule() failed for fragment shader !!!\n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateShaderModule() call success for fragment shader\n\n", __func__);
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> fragment shader module successfully created\n\n", __func__);
...
VkResult createDescriptorSetLayout(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDescriptorSetLayout() failed !!! \n\n", __func__);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDescriptorSetLayout() call success \n\n", __func__);
    }
...
VkResult createDescriptorPool(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDescriptorPool() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateDescriptorPool() call success\n\n", __func__);
    }
...
VkResult createDescriptorSet(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateDescriptorSets() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkAllocateDescriptorSets() call success\n\n", __func__);
    }
...
VkResult createRenderPass(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateRenderPass() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateRenderPass() call success\n\n", __func__);
    }
...
VkResult createPipeline(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreatePipelineCache() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreatePipelineCache() call success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateGraphicsPipelines() failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        if(vkPipelineCache)
        {
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateGraphicsPipelines() call success\n\n", __func__);
    }
...
VkResult createFrameBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if(vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateFramebuffer() failed for i = %d (ERROR CODE : %d)\n\n", __func__, i, vkResult);
            return(vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateFramebuffer() success for i = %d\n\n", __func__, i);
        }
    }
...
VkResult createSemaphores(void)
{
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSemaphore() for vkSemaphore_backBuffer failed (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSemaphore() call for vkSemaphore_backBuffer success\n\n", __func__);
    }
    ...
    if (vkResult != VK_SUCCESS)
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSemaphore() failed for vkSemaphore_renderComplete (ERROR CODE : %d )!!!\n\n", __func__, vkResult);
        return (vkResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateSemaphore() call for vkSemaphore_renderComplete success\n\n", __func__);
    }
...
VkResult createFences(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if(vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateFence() failed for i = %d (ERROR CODE : %d)\n\n", __func__, i, vkResult);
            return(vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkCreateFence() success for i = %d\n\n", __func__, i);
        }
    }
...
VkResult buildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if(vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkResetCommandBuffer() failed for i = %d (ERROR CODE : %d)\n\n", __func__, i, vkResult);
            return(vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkResetCommandBuffer() success for i = %d\n", __func__, i);
        }
        ...
        if(vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkBeginCommandBuffer() failed for i = %d (ERROR CODE : %d)\n\n", __func__, i, vkResult);
            return(vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkBeginCommandBuffer() success for i = %d\n", __func__, i);
        }
        ...
        if(vkResult != VK_SUCCESS)
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkEndCommandBuffer() failed for i = %d (ERROR CODE : %d)\n\n", __func__, i, vkResult);
            return(vkResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO, "HGK:", "%s()-> vkEndCommandBuffer() success for i = %d\n", __func__, i);
        }
    ...
    void *pUserData)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "HGK:", "HGK_VALIDATION : %s()-> %s (%d) = %s\n\n", __func__, pLayerPrefix, messageCode, pMessage);
